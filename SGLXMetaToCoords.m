...
% 
function SGLXMetaToCoords(metaName, path)
...
function [xCoord, yCoord] = XYCoord20(meta, elecInd, bankMask, shankind)   
    ...
    if pType == 21
        ...
        scatter( xCoord, yCoord, 100, 'g', 'square', 'filled' );hold on;   
        xlim([-16,64]);
        ylim([-10,10000]);
        ...
        for sI = 0:3
            ...
            scatter( shankSep*sI + xCoord(cc), yCoord(cc), 20, 'g', 'square', 'filled' ); hold on; 
        end
