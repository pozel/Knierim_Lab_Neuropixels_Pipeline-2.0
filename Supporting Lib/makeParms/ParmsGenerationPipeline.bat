...
rem python applyFullCAR.py "%~1"
rem python makePolytrodeSpikes_singleChannel.py "%~1" A %numCh% %thresh%
rem python expandCSCFile.py "%~1\A_%thresh%"
rem python makeParms.py "%~1\A_%thresh%"

rem del "%~1\A_%thresh%\*.npy"
rem del "%~1\A_%thresh%\*.npz"
rem del "%~1\A_%thresh%\*.memmap"
